        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ auth()->user() ? route('home') :url('/') }}">
                    <img width="100" src="{{ asset('assets/images/avatar/logo.png') }}" />
                    Castle Data
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('scrape.index') ? 'active' : '' }}" href="{{ route('scrape.index') }}">{{ __('Scrape') }}</a>
                        </li>
                        @endif
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item {{ request()->routeIs('users.show', auth()->user()->id) ? 'active' : '' }}" href="{{ route('users.show', auth()->user()->id) }}">
                                     {{ __('Profile') }}
                                 </a>
